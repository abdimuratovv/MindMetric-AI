...
urlpatterns = [
    ...
    path('students/export/', views.AdminStudentExportView.as_view(), name='admin-students-export'),
    path('students/<int:pk>/', views.AdminStudentDetailView.as_view(), name='admin-student-detail'),
