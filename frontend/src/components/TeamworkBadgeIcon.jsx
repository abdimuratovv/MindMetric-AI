 ...
 */
export default function TeamworkBadgeIcon({ size = 26, color }) {
  return (
    <svg className="mm-badge-icon" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round" style={{ overflow: 'visible' }}>
      ...
      <path d="M8.6 3.6l0.5 1.5 1.5 0.5-1.5 0.5-0.5 1.5-0.5-1.5-1.5-0.5 1.5-0.5z" fill="#EFB94D" stroke="none" style={{ transformOrigin: '8.6px 5.6px', animation: 'mm-badge-teamwork-spark1 3.4s ease-in-out infinite' }} />
      <path d="M15.6 3.9l0.45 1.35 1.35 0.45-1.35 0.45-0.45 1.35-0.45-1.35-1.35-0.45 1.35-0.45z" fill="#EFB94D" stroke="none" style={{ transformOrigin: '15.6px 5.65px', animation: 'mm-badge-teamwork-spark2 3.4s ease-in-out infinite' }} />
    </svg>
  );
}
